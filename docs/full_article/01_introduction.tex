...
\begin{enumerate}
    \item \textbf{Growth Curve Trajectory Learning}: A novel approach to vegetation forecasting that learns complete saturation growth curve trajectories rather than predicting iteratively step-by-step. While inspired by the growth curve decoder concept introduced by \citet{pellicer2024explainable}, our method fundamentally differs by fitting entire 100-day trajectories in a single forward pass, enabling efficient long-horizon prediction without error accumulation.
